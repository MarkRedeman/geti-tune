...
import { ImageAnnotations, InspectDialog } from './../inspect-dialog/inspect-dialog.component';
import { useMediaState, useSelectedData } from '../../../routes/data-collection/provider';
